* Audio DAC, post-PnR gate netlist, 4256 instances [n2s test case 47]
*
* === n2s test-case metadata ===
* Source:       sky130A PDK, libs.tech/xschem/xschem_verilog_import/
*               audiodac.spice (xschem Verilog-import flow)
* Circuit type: Delta-sigma audio DAC digital front-end (FIFO, volume,
*               OSR control), gate-level post-PnR
* Devices:      4256 X instances -- 3.6x the previous record (case 46).
*               2879 are physical fillers (1895 decap, 555 fill, 429
*               tap) -> ~1377 logic cells after the physical filter:
*               295 DFF, 185 clkbuf, 132 a32o, 129 o22ai, 135 mux...
* Notes:        SCALE stress for the physical-cell filter + the whole
*               scale regime at 3.5x case 46's filtered size.
